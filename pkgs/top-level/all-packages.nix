...

{
  ...
  */
  ...
  odooAddons = with pkgs; recurseIntoAttrs {
    ...
    # OCA/mail (19.0)
    base-user-signature = callPackage ../by-name/ba/base-user-signature/package.nix { };
    mail-activity-board = callPackage ../by-name/ma/mail-activity-board/package.nix { };
    mail-activity-reminder = callPackage ../by-name/ma/mail-activity-reminder/package.nix { };
    ...
    mail-partner-opt-out = callPackage ../by-name/ma/mail-partner-opt-out/package.nix { };
    mail-post-defer = callPackage ../by-name/ma/mail-post-defer/package.nix { };
    mail-restrict-follower-selection = callPackage ../by-name/ma/mail-restrict-follower-selection/package.nix { };
    ...
    mail-activity-dashboard = callPackage ../by-name/ma/mail-activity-dashboard/package.nix { };
    mail-activity-done = callPackage ../by-name/ma/mail-activity-done/package.nix { };
    mail-activity-plan-domain = callPackage ../by-name/ma/mail-activity-plan-domain/package.nix { };
    mail-autogenerated-header = callPackage ../by-name/ma/mail-autogenerated-header/package.nix { };
    mail-autosubscribe = callPackage ../by-name/ma/mail-autosubscribe/package.nix { };
    mail-composer-cc-bcc = callPackage ../by-name/ma/mail-composer-cc-bcc/package.nix { };
    mail-debrand = callPackage ../by-name/ma/mail-debrand/package.nix { };
    ...
    mail-no-user-assign-notification = callPackage ../by-name/ma/mail-no-user-assign-notification/package.nix { };
    mail-notification-clean-status-error = callPackage ../by-name/ma/mail-notification-clean-status-error/package.nix { };
    mail-notification-custom-subject = callPackage ../by-name/ma/mail-notification-custom-subject/package.nix { };
    mail-optional-follower-notification = callPackage ../by-name/ma/mail-optional-follower-notification/package.nix { };
    mail-partner-forwarding = callPackage ../by-name/ma/mail-partner-forwarding/package.nix { };
    mail-quoted-reply = callPackage ../by-name/ma/mail-quoted-reply/package.nix { };
    mail-show-follower = callPackage ../by-name/ma/mail-show-follower/package.nix { };
